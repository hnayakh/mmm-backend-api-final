...
ConnectModule = __decorate([
    common_1.Module({
        imports: [
            ...
            typeorm_1.TypeOrmModule.forFeature([user_basic_entity_1.UserBasic]),
        ],
        controllers: [cms_controller_1.CmsController],
        providers: [cms_service_1.FaqService, cms_service_1.FaqService, cms_repo_1.CmsRepo],
        exports: [cms_service_1.FaqService, cms_repo_1.CmsRepo],
    })
], ConnectModule);
exports.ConnectModule = ConnectModule;
//# sourceMappingURL=cms.mdule.js.map