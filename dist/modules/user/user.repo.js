...
let UserRepo = class UserRepo {
  constructor(
    ...
    userReligionRepo,
    userCareerRepo,
    userFamilyBackgroundRepo,
    userFamilyDetailRepo,
    userImageRepo,
    userDocRepo,
    userBioRepo,
    otpRepo,
  ...
  async createUserAbout(userAbout) {
    const existingPending = await this.userAboutRepo.findOne({
      where: {
        ...
        profileUpdationStatus:
          miscellaneous_enum_1.ProfileUpdationStatus.Pending,
      },
    });
    if (existingPending != null) {
      existingPending.profileUpdationStatus =
        miscellaneous_enum_1.ProfileUpdationStatus.Archived;
    ...
    if (existingAboutRecord != null) {
      ...
      const updatedUserBasic = userAbout.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.About,
      );
  ...
  async createUserHabit(userHabit) {
    ...
    if (existingHabitRecord != null) {
      ...
      const updatedUserBasic = userHabit.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.Habit,
      );
  ...
  async createUserFamilyDetail(ufd) {
    ...
    if (existingFamilyDetailRecord != null) {
      ...
      const updatedUserBasic = ufd.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.FamilyDetail,
      );
  ...
  async createUserFamilyBackground(ufbg) {
    ...
    if (existingFamilyBackgroundRecord != null) {
      ...
      const updatedUserBasic = ufbg.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.FamilyBackground,
      );
  ...
  async createUserCareer(userCareer) {
    ...
    if (existingCareerRecord != null) {
      ...
      const updatedUserBasic = userCareer.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.Career,
      );
  ...
  async createUserReligion(userReligion) {
    ...
    if (existingReligionRecord != null) {
      ...
      const updatedUserBasic = userReligion.userBasic.updateRegistrationStep(
        miscellaneous_enum_1.RegistrationSteps.Religion,
      );
  ...
  async visitedProfile(visitedBy, visitedTo) {
    const profileVisit = user_profile_visit_1.ProfileVisit.createVisit(
      visitedBy,
      visitedTo,
    );
...
UserRepo = __decorate(
  [
    ...
    __param(
      6,
      typeorm_1.InjectRepository(
        user_family_background_entity_1.UserFamilyBackground,
      ),
    ),
    __param(
      7,
      typeorm_1.InjectRepository(user_family_detail_entity_1.UserFamilyDetail),
    ),
    ...
    __param(
      14,
      typeorm_1.InjectRepository(user_preference_entity_1.UserPreference),
    ),
    __param(15, typeorm_1.InjectRepository(user_profile_visit_1.ProfileVisit)),
    __param(16, typeorm_1.InjectRepository(Notification)),
