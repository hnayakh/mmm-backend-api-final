...
], MessageDto.prototype, "userbasicId", void 0);
__decorate([
    class_validator_1.IsNotEmpty({ message: 'reciever basicId can not be empty.' }),
    swagger_1.ApiProperty({ example: 100 }),
    __metadata("design:type", String)
], MessageDto.prototype, "recieverBasicId", void 0);
__decorate([
